...
class MoveTreeWidget {
    ...
    /**
     * Persists the move-tree container height across reloads (drag-resize support).
    ...
    constructor(options) {
        ...
        this.#resizePersistence = new ResizePersistence({
            ...
            loadPersistedHeight: this.#loadPersistedHeight === null ? undefined : this.#loadPersistedHeight,
            persistHeight: this.#persistHeight === null ? undefined : this.#persistHeight,
            saveDebounceMs: MOVE_TREE_WIDGET_SAVE_DEBOUNCE_MS,
        });
