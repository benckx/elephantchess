...
// Manchu super-chariot (combines chariot + horse + cannon powers), displayed as chariot
pieceImageNames.set('W', 'red_chariot.png');
pieceImageNames.set('w', 'black_chariot.png');
