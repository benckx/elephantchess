    ...
    fun `renderUserProfile includes profile picture when available`() = runTest {
        ...
        val html = renderer.renderUserProfile(
            UserProfile(
                ...
                puzzleRating = 1200,
                profilePictureUrl = "https://cdn.elephantchess.io/profile-pictures/user-1.png",
            )
        )

        assertTrue(html.contains("""id="profile-picture""""))
        assertTrue(html.contains("""src="https://cdn.elephantchess.io/profile-pictures/user-1.png""""))
    }
